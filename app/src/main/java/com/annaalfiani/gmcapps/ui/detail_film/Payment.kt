...
class Payment {
    fun initPayment(context: Context, token :String, createOrder: CreateOrder, detailFilmViewModel: DetailFilmViewModel){
                    ...
                    result.response?.let {
                        when(result.status){
                            ...
                            TransactionResult.STATUS_PENDING -> {
                                ...
                                detailFilmViewModel.createOrder(token, createOrder)
